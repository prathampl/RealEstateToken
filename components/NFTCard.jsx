...
export default function NFTCard({ nft, onProfilePage }) {
  ...
  return (
    <Link href={{ pathname: "/nft-details", query: nft }}>
      ...
      dark:bg-nft-black-3 bg-white rounded-2xl 
      p-4
      m-4 minlg:m-8 sm:my-2 sm:mx-2 cursor-pointer shadow-md
      "
      >
        ...
        <div className="mt-3 flex flex-col ">
          ...
          <div className="flexBetween mt-3 minlg:mt-3 flex-row xs:flex-col xs:items-start xs:mt-3 ">
            <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-xs minlg:text-l">
              {nft.price}
